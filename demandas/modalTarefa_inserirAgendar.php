          ...
          <form method="post" id="inserirForm">
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                ...
                <div class="form-label ts-label">
                  <select class="form-select ts-input" name="idAtendente" id="clonaridAtendente">
              ...
              <div class="col-md-4">
                ...
                <div class="form-label ts-label">
                  <select class="form-select ts-input" name="idTipoOcorrencia" id="clonaridTipoOcorrencia">
                    <option value="null">Selecione</option>
                    <?php
