...
<body>
    ...
    <script>
       ...
       //Gabriel 22092023 id544 trocado setcookie por httpRequest enviado para gravar origem em session//ajax
        ...
        var orcamento = new Quill('.quill-orcamentoinserir', {
        theme: 'snow',
        modules: {
            toolbar: [
        ...
        orcamento.on('text-change', function(delta, oldDelta, source) {
        $('#quill-orcamentoinserir').val(orcamento.container.firstChild.innerHTML);
        });
    </script>
